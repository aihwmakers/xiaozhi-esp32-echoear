...
#define TP_PIN_NUM_TP_SDA   (GPIO_NUM_2)
#define TP_PIN_NUM_TP_SCL   (GPIO_NUM_1)
#define TP_PIN_NUM_TP_RST   (GPIO_NUM_NC)
#define TP_PIN_NUM_TP_INT   (GPIO_NUM_10)

#define QSPI_PIN_NUM_LCD_DC    GPIO_NUM_45
#define QSPI_PIN_NUM_LCD_TE	   GPIO_NUM_8
