...
class EspEchoEarBoard : public WifiBoard {
private:
    ...
    void InitializeSpi() {
        ...
        const spi_bus_config_t bus_config = ECHOEAR_ST77916_PANEL_BUS_QSPI_CONFIG(QSPI_PIN_NUM_LCD_PCLK,
                                                                        QSPI_PIN_NUM_LCD_DATA0,
                                                                        QSPI_PIN_NUM_LCD_DATA1,
                                                                        QSPI_PIN_NUM_LCD_DATA2,
                                                                        QSPI_PIN_NUM_LCD_DATA3,
                                                                        QSPI_LCD_H_RES * 40 * sizeof(uint16_t));
    ...
    void Initializest77916Display() {
        ...
        esp_lcd_panel_io_spi_config_t io_config = {
            ...
            .dc_gpio_num = QSPI_PIN_NUM_LCD_DC,                  
            .spi_mode = 0,                     
            .pclk_hz = 3 * 1000 * 1000,      
...
public:
    EspEchoEarBoard() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeGpio();
        InitializeI2c();
        InitializeSpi();
